###cod 5.0 objetivo ser mais rapido e pegar apenas 500 emails 
##o parametro de 2 anos esta desativado
...
def fazer_backup(email, senha):
    ...
    # Busca apenas e-mails antigos (mais de 2 anos), limitando a 500 e-mails
    ...
    # Limita a quantidade de e-mails a serem processados
